...
import com.example.myapplicationeight.ItemApplication
import com.example.myapplicationeight.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        argsType1 = getArguments()?.getInt(MainFragment.TYPE_1, 0)
        argsType2 = getArguments()?.getInt(MainFragment.TYPE_2, 1)
